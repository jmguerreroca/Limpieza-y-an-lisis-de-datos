...
```{r}
numericas <- c("age", "sex", "cp", "trtbps", "chol", "restecg", "thalachh", "oldpeak", "slp", "caa", "thall", "output")
df_num <- df[, numericas]
```
...
```{r}
summary(glm(formula = output ~ trtbps + chol + restecg + sex + age + thalachh + oldpeak, family = "binomial", data = df))
```
